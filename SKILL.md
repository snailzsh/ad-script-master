...
description: 爆款商业广告脚本生成器 - 专为 Seedance 2.0、Sora 等 AI 视频生成工具优化的广告脚本创作 Skill。当用户提到"广告脚本"、"商业广告"、"视频广告"、"UA广告"、"种子用户广告"、"带货视频"、"产品推广"、"品牌宣传片"、"广告分镜"、"视频脚本创作"，或需要创作包含场景融入、深度绑定、高转化率的商业广告内容时，务必使用此 Skill。适用于电商实物产品、SaaS工具、APP推广、品牌宣传等多种广告场景。
